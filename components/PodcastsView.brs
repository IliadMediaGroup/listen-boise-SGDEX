...
sub loadPodcasts()
    ...
    podcasts = [
        {title: "Rick & Carly On Demand", rssUrl: "https://feeds.acast.com/public/shows/674e35774cf32e7 zakonb944eccd3", poster: "pkg:/images/rick_carly.png"},
        ...
        {title: "Up Next", rssUrl: "https://feeds.acast.com/public/shows/675237e3d40c6cb2e0112347", poster: "pkg:/images/up_next.png"},
        {title: "The Marketing Expedition", rssUrl: "https://static.adorilabs.com/feed/marketing-expedition-podcast-with-rhea-allen-peppershock-media-7682.xml", poster: "pkg:/images/marketing_expedition.png"},
        {title: "Brain Over Belly", rssUrl: "https://feeds.acast.com/public/shows/6750f308f318f34867692de2", poster: "pkg:/images/brain_over_belly.png"},
        {title: "BoiseDev Podcast", rssUrl: "https://feeds.acast.com/public/shows/6750d305aeaa2d78dfb137bf", poster: "pkg:/images/boisedev.png"}
    ]
...
sub onEpisodeSelected()
    ...
    if selectedItem <> invalid
        ...
        content.streamFormat = "mp4" ' Assuming video podcasts are MP4
        ...
        ' Show playback card with play/pause
